package ch.khinkali.cryptowatch.user.events.boundary;
...
public class EventSerializer implements Serializer<UserCreated> {
    ...
    @Override
    public byte[] serialize(final String topic, final UserCreated event) {
        try {
            if (event == null) {
                return null;
            }
